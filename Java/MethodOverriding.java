 ...
 * 
  class Sports{
    ...
    * Next, we create a Soccer class that inherits from the Sports class. We can override the getName method 
    * and return a different, subclass-specific string:
 ...
 */
/**NOTE :  When overriding a method, you should precede it with the
 *  @Override annotation. The parameter(s) and return type of an 
...
import java.util.*;
//Parent class with two methods with body
class Sports{
...
//Child class overriding both methods of parent class.
class Soccer extends Sports{
    @Override
    String getName(){
        return "Soccer Class";
...
public class MethodOverriding {
    public static void main(String[] args) {
        //object of Sports class.
        Sports c1 = new Sports();
        //object of Soccer class;
